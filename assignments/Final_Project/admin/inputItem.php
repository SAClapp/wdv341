...
if($_SESSION['validUser'] == "valid"){
    ...
    $inItemName = "";    //default value to display on the form the first time it is requested
    $inItemDesc = "";
    $inItemPrice = "";
    $inItemDateAdd = "";
    $inItemType = "";
    ...
    if($validInput){
        ...
        //build mySQL command
        $sql = "INSERT INTO menu_items_table";
        $sql .= "(item_name, item_desc, item_price, item_date_added, item_type, item_date_updated)";
        $sql .= " VALUES ";
        $sql .= "(:itemName, :itemDesc, :itemPrice, :itemDateAdd, :itemType, :itemDateUpdated)";
...
<header>
            <div class="mt-4 p-5 ">
              ...
              <h1>Savanna's Coffee Shop Admin</h1>
